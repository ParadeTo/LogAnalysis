...
public class PV { 
    ...
    public static class KPIPVMapper extends MapReduceBase implements Mapper<Object, Text, Text, Text> {
    ...
    public static class KPIPVReducer extends MapReduceBase implements Reducer<Text, Text, Text, Text> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        conf.setJobName("PV");
        //conf.addResoCopyOfKPIPVurce("classpath:/hadoop/core-site.xml");
